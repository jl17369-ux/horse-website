...
function draw() {
  ...
  rect (width/5 - 35, height/6.8 -50,45,100)
  ...
  pop();
  textSize(32)
  text("go back using the arrows on the top left corner of your browser", 50,30)
  text("use arrow keys to move around", 50,300)
}
